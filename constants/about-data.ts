export const teachers: { id: number; name: string; image: string; description: string }[] = [
  {
    ...
    description: `Gangesha Chaitanya (Yoga Philosophy, Meditation, Pranayama And Spiritual Guidance)
Explore the captivating world of Yogi Gangesha Chaitanya, a master of Yoga Philosophy, Meditation, Pranayama, and Spiritual Guidance. Guided by the revered saint Swami Rama from a young age, Yogi Gangesha has become a beacon of wisdom and compassion.
...
Immerse yourself in the transformative teachings of Yogi Gangesha Chaitanya, a master of Yoga Philosophy, Meditation, Pranayama, and Spiritual Guidance. With guidance from revered saints and immersion in renowned yoga traditions, Yogi Gangesha offers a harmonious blend of ancient wisdom and modern insights. Experience the serene aura of his classes as he leads you on a journey to awaken your kundalini energy and explore higher consciousness. Join him to unlock the limitless potential of your mind and spirit, embracing the magic of meditation and spiritual wisdom. Let Yogi Gangesha illuminate your path to inner harmony and enlightenment.`
  },
  {
    ...
    description: `Sukra Chiatanya (Meditation, Mantra And Pranayama)
...
Yogi Sukra Chaitanya's teachings resonate like a beautiful symphony, bringing harmony to the mind, body, and soul, attracting seekers from around the world. With each breath, his students uncover the profound treasures within themselves, guided by the wisdom of a true master.`
  },
  {
    ...
    description: `Purnima Ji (Pranayama & Meditation)
...
export const courses = [
  {
    ...
    image: "https://images.unsplash.com/photo-1602594748821-6df031e275e1?q=80&w=3027&auto=format&fit=crop&ixlib=rb-4.0.3",
    href: "/courses/kundalini"
  },
  {
    title: "200-HOUR Hatha Yoga Teacher Training Course - 45 Day Program",
    image: "https://images.unsplash.com/photo-1547852356-b20668106c51?q=80&w=3087&auto=format&fit=crop&ixlib=rb-4.0.3",
    href: "/courses/pranayama"
  },
  {
    title: "100-Vinyasa-Flow-Yoga-Teacher-Training Course - 30 Days Program",
    image: "https://plus.unsplash.com/premium_photo-1666264200751-8a013663a89b?q=80&w=2940&auto=format&fit=crop&ixlib=rb-4.0.3",
