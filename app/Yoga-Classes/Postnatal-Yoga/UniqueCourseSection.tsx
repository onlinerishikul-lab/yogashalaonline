...
const UniqueCourseSection = () => {
  const items = [
    {
      title: "Certified Postnatal Yoga Experts",
      icon: <Users className="w-6 h-6 text-sky-600" />,
    },
    {
      title: "Safe Recovery & Strengthening Techniques",
      icon: <Sun className="w-6 h-6 text-sky-600" />,
    },
    {
      title: "Focus on Mother & Baby Wellness",
    ...
    <section className="bg-white py-16 px-6 md:px-10 lg:px-20">
      <div className="max-w-6xl mx-auto text-center mb-10">
        <h2 className="text-3xl md:text-4xl font-bold text-sky-600">
          What Makes Our “Postnatal Yoga” Course Unique?
        </h2>
        <p className="text-gray-600 mt-4 max-w-2xl mx-auto text-sm md:text-base">
          Support new mothers on their journey to recovery and strength with our specialized Postnatal Yoga course.  
          Learn safe, effective practices tailored to postpartum needs, promoting healing, balance, and wellness for both mother and baby.
        </p>
      </div>
