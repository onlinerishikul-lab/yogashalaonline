...
const features = [
  ...
  "✅ 85-Hour Prenatal & Postnatal Yoga Curriculum",
    ...
    <div className="relative bg-[#e8eefb] rounded-2xl p-8 max-w-3xl w-full overflow-hidden">
      <div className="text-center md:text-left">
        ...
        <p className="text-gray-700 mb-4">
          ...
          <strong>85-Hour Prenatal & Postnatal Yoga</strong> course. But if it
      ...
      <section className="flex flex-col md:flex-row justify-between items-start gap-10">
        <div className="md:w-1/2 space-y-4">
          <h1 className="text-3xl md:text-4xl font-bold text-[#4377b2] leading-snug">
            85-Hour Prenatal & Postnatal Yoga Course
          </h1>
          <p className="text-gray-700 text-sm">
            Learn specialized yoga practices designed to support women during
            pregnancy and postpartum recovery with this comprehensive 85-hour
            course.
          </p>
          <ul className="list-disc list-inside text-sm text-gray-700 space-y-1">
            <li>Safe prenatal yoga sequences and modifications.</li>
            <li>Postnatal recovery and strengthening exercises.</li>
            <li>Breathwork and meditation for maternal wellbeing.</li>
            <li>Downloadable guides and lifetime course access.</li>
            <li>Perfect for yoga teachers and prenatal practitioners.</li>
          </ul>
