...
const features = [
  ...
  "✅ 25-Hour Ayurveda Immunity Boost Curriculum",
  "✅ Downloadable Immunity Guide",
    ...
    <div className="relative bg-[#e8eefb] rounded-2xl p-8 max-w-3xl w-full overflow-hidden">
      <div className="text-center md:text-left">
        ...
        <p className="text-gray-700 mb-4">
          ...
          <strong>25-Hrs Ayurveda Immunity Course</strong>. But if it doesn’t meet your expectations, we’ve got you covered.
        </p>
        <p className="text-gray-700 mb-4">
      ...
      <section className="flex flex-col md:flex-row justify-between items-start gap-10">
        <div className="md:w-1/2 space-y-4">
          <h1 className="text-3xl md:text-4xl font-bold text-[#4377b2] leading-snug">
            25-Hrs Ayurveda Courses <br /> Ayurveda Immunity Course
          </h1>
          <p className="text-gray-700 text-sm">
            Strengthen your body’s natural defenses with ancient Ayurvedic practices, herbs, and lifestyle guidance designed to boost immunity and vitality.
          </p>
          <ul className="list-disc list-inside text-sm text-gray-700 space-y-1">
            <li>Learn Ayurvedic principles for immune health.</li>
            <li>Discover herbal remedies and dietary tips.</li>
            <li>Explore daily routines to support lifelong wellness.</li>
            <li>Includes HD video lessons and downloadable resources.</li>
            <li>Ideal for health enthusiasts and Ayurveda practitioners.</li>
          </ul>
