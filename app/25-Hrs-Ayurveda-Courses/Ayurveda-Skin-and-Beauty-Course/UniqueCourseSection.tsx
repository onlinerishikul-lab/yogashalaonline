...
import { Droplet, Leaf, Star, Heart } from "lucide-react";

const UniqueCourseSection = () => {
  const items = [
    {
      title: "Natural Skin Care Techniques",
      icon: <Droplet className="w-6 h-6 text-sky-600" />,
    },
    {
      title: "Herbal Beauty Remedies",
      icon: <Leaf className="w-6 h-6 text-sky-600" />,
    },
    {
      title: "Holistic Wellness for Radiance",
      icon: <Star className="w-6 h-6 text-sky-600" />,
    },
    {
      title: "Expert Ayurvedic Guidance",
    ...
    <section className="bg-white py-16 px-6 md:px-10 lg:px-20">
      <div className="max-w-6xl mx-auto text-center mb-10">
        <h2 className="text-3xl md:text-4xl font-bold text-sky-600">
          What Makes Our “25-Hrs Ayurveda Courses / Ayurveda Skin and Beauty Course” Unique?
        </h2>
        <p className="text-gray-600 mt-4 max-w-2xl mx-auto text-sm md:text-base">
          Discover the secrets of radiant skin and natural beauty with Ayurveda. This 25-hour course covers herbal skincare, detoxifying rituals, and holistic practices to enhance your glow inside and out.
        </p>
      </div>
