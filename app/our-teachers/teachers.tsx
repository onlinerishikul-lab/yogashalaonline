    ...
    <div className="bg-white text-[#4377b2] min-h-screen py-12 px-4 sm:px-8">
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-10">
        {teachers.map((teacher) => (
          <div key={teacher.id} className="bg-[#4377b2] text-white rounded-lg shadow-lg p-6 hover:shadow-2xl transition duration-300">
            ...
            <h4 className="italic text-sm mb-2">{teacher.Subtitle}</h4>
            <p className="text-sm whitespace-pre-line line-clamp-[10]">{teacher.description}</p>
          </div>
        ))}
      </div>
    </div>
