      ...
      <div className="max-w-6xl mx-auto flex flex-col-reverse md:flex-row items-center justify-between gap-12">
        ...
        <div className="md:w-1/2 text-center md:text-left">
          <h2 className="text-3xl md:text-5xl font-extrabold mb-5 leading-tight">
            Ready to Earn Your <br /> Yoga Therapy Certificate?
          </h2>
          <p className="text-lg mb-8 text-[#f9fafb]">
            Discover the healing power of yoga through our Yoga Therapy Course. 
            Learn to assess and apply yogic techniques for physical, mental, and emotional wellness. 
            Complete the training and receive your professional certificate.
          </p>
        ...
        <div className="md:w-1/2 flex justify-center">
          <Image
            ...
            alt="Yoga Therapy Certificate Preview"
            width={512}
            height={212}
