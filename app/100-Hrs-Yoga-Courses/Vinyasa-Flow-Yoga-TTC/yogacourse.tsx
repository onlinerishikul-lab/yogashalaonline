...
const features = [
  ...
  "✅ 100-Hour Vinyasa Flow Yoga TTC Curriculum",
...
const PricingOptions = () => (
  <div className="flex flex-nowrap justify-center items-start gap-4 overflow-x-auto pb-2">
    <PricingCard
      ...
      description="Pay once and unlock full access."
      price="$900.00"
    ...
    <div className="relative bg-[#e8eefb] rounded-2xl p-8 max-w-3xl w-full overflow-hidden">
      <div className="text-center md:text-left">
        ...
        <p className="text-gray-700 mb-4">
          ...
          <strong>100-Hrs Vinyasa Flow Yoga TTC</strong>. But if it doesn’t meet your
          expectations, we’ve got you covered.
        </p>
        <p className="text-gray-700 mb-4">
          Simply email us within <strong>14 days</strong> of purchase for a full
      ...
      <section className="flex flex-col md:flex-row justify-between items-start gap-10">
        <div className="md:w-1/2 space-y-4">
          <h1 className="text-3xl md:text-4xl font-bold text-[#4377b2] leading-snug">
            100-Hrs Vinyasa Flow Yoga Teacher Training Course
          </h1>
          <p className="text-gray-700 text-sm">
            Transform your yoga journey with the foundational 100-hour Vinyasa
            Flow Yoga TTC—designed for aspiring teachers and dedicated practitioners.
          </p>
          <ul className="list-disc list-inside text-sm text-gray-700 space-y-1">
            <li>Master Vinyasa Flow sequences with breath-to-movement alignment.</li>
            <li>Build strength, flexibility, and mindfulness through dynamic flow.</li>
            <li>Includes pranayama, meditation, and teaching methodology.</li>
            <li>Lifetime access to video lessons, manual & practice plans.</li>
            <li>Great for beginners or intermediate practitioners & future teachers.</li>
          </ul>
        ...
        <div className="md:w-1/2 w-full">
          ...
          <div className="text-center text-xs text-gray-500 mt-2">
            🔒 100% Secure Payment. Full refund within 14 days if you’re not
            satisfied.
          </div>
        </div>
      </section>
