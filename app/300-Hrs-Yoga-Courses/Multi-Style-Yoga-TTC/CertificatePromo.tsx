...
Earn Your 300-Hour Multi-Style Yoga Certificate

          </h2>
          <p className="text-base sm:text-lg mb-8 text-[#f9fafb]">
Complete this comprehensive training to become a skilled, versatile yoga instructor with an internationally recognized certification. Elevate your teaching and personal practice to the next level.
          </p>
          <Link href="/contact">
