      ...
      <div className="max-w-6xl mx-auto flex flex-col-reverse md:flex-row items-center justify-between gap-12">
        ...
        <div className="md:w-1/2 text-center md:text-left">
          <h2 className="text-3xl md:text-5xl font-extrabold mb-5 leading-tight">
            Ready to Earn Your <br /> 50-Hrs Yoga Therapy Course Certificate?
          </h2>
          <p className="text-lg mb-8 text-[#f9fafb]">
            Specialize in healing and rehabilitation with yoga therapy. Complete our 50-hour Yoga Therapy Course online and get certified to help others heal through yoga.
          </p>
          <Link href="/50-Hrs-Yoga-Courses/Yoga-Therapy-Course" passHref legacyBehavior>
        ...
        <div className="md:w-1/2 flex justify-center">
          <Image
            ...
            alt="50-Hrs Yoga Therapy Course Certificate Preview"
            width={512}
            height={212}
