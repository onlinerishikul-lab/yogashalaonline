...
const features = [
  ...
  "✅ 95-Hour Kids Yoga Curriculum",
  "✅ Fun and Engaging Training Materials",
    ...
    <div className="relative bg-[#e8eefb] rounded-2xl p-8 max-w-3xl w-full overflow-hidden">
      <div className="text-center md:text-left">
        ...
        <p className="text-gray-700 mb-4">
          ...
          <strong>95-Hour Kids Yoga Course</strong>. But if it doesn’t meet your
      ...
      <section className="flex flex-col md:flex-row justify-between items-start gap-10">
        <div className="md:w-1/2 space-y-4">
          ...
          <p className="text-gray-700 text-sm">
            Engage children in healthy physical and mental development through
            this fun and comprehensive 95-hour Kids Yoga course.
          </p>
          <ul className="list-disc list-inside text-sm text-gray-700 space-y-1">
            <li>Creative yoga sequences designed for kids.</li>
            <li>Breathwork and mindfulness activities suitable for children.</li>
            <li>Fun games and movement practices to build confidence.</li>
            <li>Downloadable lesson plans and lifetime access.</li>
            <li>Ideal for yoga teachers and parents alike.</li>
          </ul>
