...
const features = [
  ...
  "✅ Comprehensive Hatha Yoga Curriculum",
    ...
    <div className="relative bg-[#e8eefb] rounded-2xl p-8 max-w-3xl w-full overflow-hidden">
      <div className="text-center md:text-left">
        ...
        <p className="text-gray-700 mb-4">
          ...
          <strong>Hatha Yoga Course</strong>. But if it doesn’t meet your
      ...
      <section className="flex flex-col md:flex-row justify-between items-start gap-10">
        <div className="md:w-1/2 space-y-4">
          ...
          <p className="text-gray-700 text-sm">
            Dive deep into the ancient practice of Hatha Yoga, focusing on breath,
            posture, and mindfulness to build strength and flexibility.
          </p>
          <ul className="list-disc list-inside text-sm text-gray-700 space-y-1">
            <li>Learn foundational Hatha postures and alignment.</li>
            <li>Develop breath control and meditation techniques.</li>
            <li>Understand the philosophy behind Hatha Yoga.</li>
            <li>Includes detailed video lessons and practice guides.</li>
            <li>Perfect for beginners and intermediate practitioners.</li>
          </ul>
