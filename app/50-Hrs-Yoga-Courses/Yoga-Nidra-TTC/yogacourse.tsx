...
const features = [
  ...
  "✅ 50-Hour Yoga Nidra Curriculum",
  "✅ Downloadable Course Materials",
  "✅ Lifetime Course Access",
  "✅ 24 Months Instructor Support",
];
...
const PricingOptions = () => (
  <div className="flex flex-nowrap justify-center items-start gap-4 overflow-x-auto pb-2">
    <PricingCard
      ...
      description="Access full course with single payment."
      price="$299.00"
      note="One-time payment"
    />
    <PricingCard
      title="Two-Part Installments"
      description="Split payment into two installments."
      price="$155.00 x 2"
      note="Billed monthly"
    />
    <PricingCard
      title="Three-Part Installments"
      description="Pay in three convenient parts."
      price="$105.00 x 3"
      note="Billed monthly"
    />
  </div>
    ...
    <div className="relative bg-[#e8eefb] rounded-2xl p-8 max-w-3xl w-full overflow-hidden">
      <div className="text-center md:text-left">
        ...
        <p className="text-gray-700 mb-4">
          We believe you’ll love our{" "}
          <strong>50-Hour Yoga Nidra Teacher Training Course</strong>. If not,
          simply request a refund within 7 days of purchase—no questions asked.
        </p>
        <p className="text-gray-700 mb-4">
          Start your journey into Yoga Nidra teaching with confidence and peace
          of mind.
        </p>
        <p className="text-gray-900 font-semibold mb-6">
          Enroll risk-free today and unlock deep relaxation techniques.
        </p>
      ...
      <section className="flex flex-col md:flex-row justify-between items-start gap-10">
        <div className="md:w-1/2 space-y-4">
          <h1 className="text-3xl md:text-4xl font-bold text-[#4377b2] leading-snug">
            50-Hour Yoga Nidra <br /> Teacher Training Course
          </h1>
          <p className="text-gray-700 text-sm">
            Discover the ancient practice of Yoga Nidra to guide profound
            relaxation and healing. This course prepares you to teach deep
            guided meditation techniques to your students.
          </p>
          <ul className="list-disc list-inside text-sm text-gray-700 space-y-1">
            <li>Learn step-by-step Yoga Nidra protocols for all levels.</li>
            <li>Understand scientific benefits of guided sleep meditation.</li>
            <li>Access downloadable course materials and scripts.</li>
            <li>Perfect for yoga teachers, therapists, and wellness coaches.</li>
            <li>Includes lifetime course access and instructor support.</li>
          </ul>
