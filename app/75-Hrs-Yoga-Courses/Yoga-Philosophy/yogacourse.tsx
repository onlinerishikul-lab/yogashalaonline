...
const features = [
  ...
  "✅ 75-Hour Yoga Philosophy Curriculum",
    ...
    <div className="relative bg-[#e8eefb] rounded-2xl p-8 max-w-3xl w-full overflow-hidden">
      <div className="text-center md:text-left">
        ...
        <p className="text-gray-700 mb-4">
          We’re confident you’ll find immense value in the{" "}
          <strong>75-Hrs Yoga Philosophy</strong> course. But if it doesn’t meet
          your expectations, we’ve got you covered.
        </p>
        <p className="text-gray-700 mb-4">
      ...
      <section className="flex flex-col md:flex-row justify-between items-start gap-10">
        <div className="md:w-1/2 space-y-4">
          <h1 className="text-3xl md:text-4xl font-bold text-[#4377b2] leading-snug">
            75-Hrs Yoga Philosophy Course
          </h1>
          <p className="text-gray-700 text-sm">
            Immerse yourself in the timeless wisdom of yoga philosophy with this
            comprehensive 75-hour course exploring core concepts, texts, and
            practices.
          </p>
          <ul className="list-disc list-inside text-sm text-gray-700 space-y-1">
            <li>Study of ancient yoga scriptures and philosophies.</li>
            <li>Practical applications of yoga principles in daily life.</li>
            <li>Exploration of meditation, ethics, and mindfulness.</li>
            <li>Downloadable materials and lifetime access.</li>
            <li>Ideal for serious students and yoga teachers.</li>
          </ul>
