...
const CourseDetails = () => {
  const features = [
    ...
    { id: 2, icon: <Zap />, title: "Ayurvedic Daily Routines" },
    ...
    { id: 7, icon: <Settings />, title: "Holistic Health & Wellness" },
    { id: 8, icon: <Activity />, title: "Mind-Body Balance Techniques" },
    ...
    <section className="bg-[#f9fafb] text-[#4377b2] py-20 px-6">
      <div className="max-w-6xl mx-auto text-center">
        ...
        <p className="mb-10 max-w-2xl mx-auto text-lg leading-relaxed text-[#4377b2]/90">
          Adopt a balanced Ayurvedic lifestyle with personalized daily routines, nutrition, and mindfulness practices to enhance your health and vitality.
        </p>
        <button className="mb-12 border-2 border-[#4377b2] text-[#4377b2] font-semibold px-8 py-3 rounded-full hover:bg-[#4377b2] hover:text-white transition">
          Enroll in Ayurvedic Lifestyle Course
        </button>
            ...
            >
              ...
              <div>
                ...
                <p className="text-sm text-[#4377b2]/80">
                  Learn practical strategies to harmonize your mind, body, and environment using Ayurvedic principles.
                </p>
              </div>
            </div>
          ))}
