...
const features = [
  ...
  "✅ Guided Mindfulness & Concentration Techniques",
    ...
    <div className="relative bg-[#e8eefb] rounded-2xl p-8 max-w-3xl w-full overflow-hidden">
      <div className="text-center md:text-left">
        ...
        <p className="text-gray-700 mb-4">
          ...
          <strong>50-Hour Meditation Teacher Training Course</strong>. If not, request a full
          refund within 7 days.
        </p>
        <p className="text-gray-700 mb-4">
          Learn powerful meditation techniques, mindfulness, and breathing exercises to deepen your practice and teach others.
        </p>
        <p className="text-gray-900 font-semibold mb-6">
          Start your mindful journey risk-free today.
        </p>
      ...
      <section className="flex flex-col md:flex-row justify-between items-start gap-10">
        <div className="md:w-1/2 space-y-4">
          <h1 className="text-3xl md:text-4xl font-bold text-[#4377b2] leading-snug">
            50-Hour Meditation Teacher Training Course <br /> Deepen Your Practice & Teach
          </h1>
          <p className="text-gray-700 text-sm">
            Master mindfulness, breathing, and guided meditation techniques to transform your life and help others do the same.
          </p>
          <ul className="list-disc list-inside text-sm text-gray-700 space-y-1">
            <li>Learn various meditation styles and teaching methods.</li>
            <li>Develop mindfulness skills for stress relief and focus.</li>
            <li>Includes video lessons, guided practices, and teaching resources.</li>
            <li>Ideal for aspiring meditation instructors and practitioners.</li>
            <li>Lifetime access with ongoing instructor support.</li>
          </ul>
