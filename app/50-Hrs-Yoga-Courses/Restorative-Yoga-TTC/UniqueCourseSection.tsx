...
const UniqueCourseSection = () => {
  const items = [
    {
      title: "Experienced Restorative Yoga Teachers",
      icon: <Users className="w-6 h-6 text-sky-600" />,
    },
    {
      title: "Deep Relaxation & Healing Techniques",
      icon: <Sun className="w-6 h-6 text-sky-600" />,
    },
    {
      title: "Certified Teacher Training Course",
      icon: <GraduationCap className="w-6 h-6 text-sky-600" />,
    },
    {
      title: "Personal Progress & Relaxation Tracking",
    ...
    <section className="bg-white py-16 px-6 md:px-10 lg:px-20">
      <div className="max-w-6xl mx-auto text-center mb-10">
        <h2 className="text-3xl md:text-4xl font-bold text-sky-600">
          What Makes Our “50-Hrs Restorative Yoga TTC” Unique?
        </h2>
        <p className="text-gray-600 mt-4 max-w-2xl mx-auto text-sm md:text-base">
          Experience gentle yoga designed to relax the body deeply and restore energy.
          This 50-hour teacher training course prepares you to guide restorative yoga sessions.
        </p>
      </div>
