...
const UniqueCourseSection = () => {
  const items = [
    {
      title: "Certified Yoga Nidra Experts",
      icon: <Users className="w-6 h-6 text-sky-600" />,
    },
    {
      title: "Deep Sleep & Conscious Relaxation",
    ...
    {
      title: "Track Your Relaxation Progress",
    ...
    <section className="bg-white py-16 px-6 md:px-10 lg:px-20">
      <div className="max-w-6xl mx-auto text-center mb-10">
        <h2 className="text-3xl md:text-4xl font-bold text-sky-600">
          What Makes Our “50-Hrs Yoga Nidra TTC” Unique?
        </h2>
        <p className="text-gray-600 mt-4 max-w-2xl mx-auto text-sm md:text-base">
          Master the art of Yoga Nidra for deep relaxation and healing sleep.
          This 50-hour course trains you to teach this powerful guided meditation technique.
        </p>
      </div>
