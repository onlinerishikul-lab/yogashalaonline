...
const CourseDetails = () => {
  const features = [
    ...
    { id: 2, icon: <Zap />, title: "Ayurvedic Immunity Fundamentals" },
    ...
    { id: 7, icon: <Settings />, title: "Immunity-Boosting Practices" },
    { id: 8, icon: <Activity />, title: "Herbal & Lifestyle Guidance" },
    { id: 9, icon: <Users />, title: "Expert Support & Mentorship" },
  ];
    ...
    <section className="bg-[#f9fafb] text-[#4377b2] py-20 px-6">
      <div className="max-w-6xl mx-auto text-center">
        ...
        <p className="mb-10 max-w-2xl mx-auto text-lg leading-relaxed text-[#4377b2]/90">
          Strengthen your natural immunity through Ayurveda’s holistic principles, including diet, herbs, and daily routines for optimal health.
        </p>
        <button className="mb-12 border-2 border-[#4377b2] text-[#4377b2] font-semibold px-8 py-3 rounded-full hover:bg-[#4377b2] hover:text-white transition">
          Enroll in Ayurveda Immunity Course
        </button>
            ...
            >
              ...
              <div>
                ...
                <p className="text-sm text-[#4377b2]/80">
                  Learn effective Ayurvedic techniques to boost immunity naturally and maintain long-term wellness.
                </p>
              </div>
            </div>
          ))}
