      ...
      <div className="max-w-6xl mx-auto flex flex-col-reverse md:flex-row items-center justify-between gap-12">
        ...
        <div className="md:w-1/2 text-center md:text-left">
          <h2 className="text-3xl md:text-5xl font-extrabold mb-5 leading-tight">
            Earn Your Reversing Diabetes Yoga Certificate
          </h2>
          <p className="text-lg mb-8 text-[#f9fafb]">
           Complete the course and earn a certification that equips you to manage your own health—or help others—through yoga-based diabetic care and holistic healing.
          </p>
