...
const UniqueCourseSection = () => {
  const items = [
    {
      title: "Certified Pranayama Instructors",
      icon: <Users className="w-6 h-6 text-sky-600" />,
    },
    {
      title: "Breath Control & Energy Regulation",
      icon: <Sun className="w-6 h-6 text-sky-600" />,
    },
    {
      title: "Techniques for Mental Clarity & Calm",
    ...
    <section className="bg-white py-16 px-6 md:px-10 lg:px-20">
      <div className="max-w-6xl mx-auto text-center mb-10">
        <h2 className="text-3xl md:text-4xl font-bold text-sky-600">
          What Makes Our “Pranayama” Course Unique?
        </h2>
        <p className="text-gray-600 mt-4 max-w-2xl mx-auto text-sm md:text-base">
          Master the ancient art of breath control with our Pranayama course.  
          Learn diverse breathing techniques designed to enhance energy flow, reduce stress, and promote overall wellness.
        </p>
      </div>
