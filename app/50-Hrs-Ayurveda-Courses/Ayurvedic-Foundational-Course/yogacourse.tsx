...
const features = [
  ...
  "✅ 50-Hour Ayurvedic Foundational Curriculum",
    ...
    <div className="relative bg-[#e8eefb] rounded-2xl p-8 max-w-3xl w-full overflow-hidden">
      <div className="text-center md:text-left">
        ...
        <p className="text-gray-700 mb-4">
          ...
          <strong>50-Hrs Ayurvedic Foundational Course</strong>. But if it doesn’t meet your expectations, we’ve got you covered.
        </p>
        <p className="text-gray-700 mb-4">
      ...
      <section className="flex flex-col md:flex-row justify-between items-start gap-10">
        <div className="md:w-1/2 space-y-4">
          <h1 className="text-3xl md:text-4xl font-bold text-[#4377b2] leading-snug">
            50-Hrs Ayurveda Courses <br /> Ayurvedic Foundational Course
          </h1>
          <p className="text-gray-700 text-sm">
            Build a solid foundation in Ayurveda with comprehensive teachings on principles, diagnosis, and daily wellness practices for balanced living.
          </p>
          <ul className="list-disc list-inside text-sm text-gray-700 space-y-1">
            <li>Explore Ayurveda’s history, principles, and dosha theory.</li>
            <li>Learn methods for pulse diagnosis and wellness assessment.</li>
            <li>Understand daily routines (Dinacharya) for health maintenance.</li>
            <li>Includes HD video lessons and downloadable foundational guides.</li>
            <li>Ideal for beginners and those seeking holistic health knowledge.</li>
          </ul>
