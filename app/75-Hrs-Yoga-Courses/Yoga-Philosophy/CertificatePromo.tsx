      ...
      <div className="max-w-6xl mx-auto flex flex-col-reverse md:flex-row items-center justify-between gap-12">
        ...
        <div className="md:w-1/2 text-center md:text-left">
          <h2 className="text-3xl md:text-5xl font-extrabold mb-5 leading-tight">
            Explore the Depth of <br /> 75-Hrs Yoga Philosophy Course
          </h2>
          <p className="text-lg mb-8 text-[#f9fafb]">
            Delve into the timeless wisdom and teachings behind yoga with our 
            75-Hour Yoga Philosophy course. Understand the mind-body connection and 
            elevate your practice from within.
          </p>
          <Link href="/75-hrs-yoga-courses/yoga-philosophy" passHref legacyBehavior>
        ...
        <div className="md:w-1/2 flex justify-center">
          <Image
            ...
            alt="75-Hrs Yoga Philosophy Certificate Preview"
            width={512}
            height={212}
