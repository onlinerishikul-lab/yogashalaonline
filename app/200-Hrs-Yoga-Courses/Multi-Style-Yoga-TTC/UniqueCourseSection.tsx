...
const UniqueCourseSection = () => {
  const items = [
    {
      title: "Experienced Multi-Style Yoga Trainers",
      icon: <Users className="w-6 h-6 text-sky-600" />,
    },
    {
      title: "Comprehensive 200-Hour Teacher Training",
    ...
    {
      title: "Master Various Yoga Styles & Techniques",
    ...
    <section className="bg-white py-16 px-6 md:px-10 lg:px-20">
      <div className="max-w-6xl mx-auto text-center mb-10">
        <h2 className="text-3xl md:text-4xl font-bold text-sky-600">
          What Makes Our “200-Hrs Yoga Courses / Multi-Style Yoga TTC” Unique?
        </h2>
        <p className="text-gray-600 mt-4 max-w-2xl mx-auto text-sm md:text-base">
          Elevate your yoga teaching skills with our 200-hour Multi-Style Yoga Teacher Training Course.  
          Gain deep knowledge and hands-on experience across various yoga traditions to become a versatile, confident instructor.
        </p>
      </div>
