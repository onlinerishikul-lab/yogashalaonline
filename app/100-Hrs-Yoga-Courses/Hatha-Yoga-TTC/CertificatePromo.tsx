      ...
      <div className="max-w-6xl mx-auto flex flex-col-reverse md:flex-row items-center justify-between gap-12">
        ...
        <div className="md:w-1/2 text-center md:text-left">
          <h2 className="text-3xl md:text-5xl font-extrabold mb-5 leading-tight">
            Enroll in Our <br /> 100-Hrs Hatha Yoga TTC
          </h2>
          <p className="text-lg mb-8 text-[#f9fafb]">
            Experience the fundamentals and depth of Hatha Yoga with our 100-Hour Teacher Training Course.  
            Build a strong foundation to become a certified yoga instructor and deepen your practice.
          </p>
          <Link href="/100-hrs-yoga-courses/hatha-yoga-ttc" passHref legacyBehavior>
        ...
        <div className="md:w-1/2 flex justify-center">
          <Image
            ...
            alt="100-Hrs Hatha Yoga TTC Certificate Preview"
            width={512}
            height={212}
