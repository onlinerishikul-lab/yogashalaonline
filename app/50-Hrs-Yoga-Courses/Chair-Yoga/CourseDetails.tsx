...
const CourseDetails = () => {
  const features = [
    ...
    { id: 7, icon: <Settings />, title: "Posture & Mobility Tools" },
    { id: 8, icon: <Activity />, title: "Improve Strength & Flexibility" },
    { id: 9, icon: <Users />, title: "Support from Certified Instructors" },
  ];
    ...
    <section className="bg-[#f9fafb] text-[#4377b2] py-20 px-6">
      <div className="max-w-6xl mx-auto text-center">
        <h2 className="text-4xl md:text-5xl font-bold mb-6">
          What Will You Learn in Chair Yoga?
        </h2>
        <p className="mb-10 max-w-2xl mx-auto text-lg leading-relaxed text-[#4377b2]/90">
          Discover accessible yoga practices designed to increase mobility, strength, and relaxation using a chair. Our 50-hour course is perfect for all ages and fitness levels.
        </p>
            ...
            >
              ...
              <div>
                ...
                <p className="text-sm text-[#4377b2]/80">
                  Learn safe and effective chair yoga sequences that improve your posture, flexibility, and overall well-being from experienced instructors.
                </p>
              </div>
            </div>
          ))}
