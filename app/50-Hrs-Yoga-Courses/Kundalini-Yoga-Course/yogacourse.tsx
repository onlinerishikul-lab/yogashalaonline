...
const features = [
  ...
  "✅ 50-Hour Kundalini Yoga Curriculum",
    ...
    <div className="relative bg-[#e8eefb] rounded-2xl p-8 max-w-3xl w-full overflow-hidden">
      <div className="text-center md:text-left">
        ...
        <p className="text-gray-700 mb-4">
          We’re confident you’ll benefit from the{" "}
          <strong>50-Hour Kundalini Yoga Course</strong>. If not, request a full
          refund within 7 days.
        </p>
        <p className="text-gray-700 mb-4">
          Experience powerful Kundalini techniques including breathwork,
          meditation, and dynamic kriyas designed to awaken your inner energy.
        </p>
        <p className="text-gray-900 font-semibold mb-6">
          Begin your transformational journey risk-free today.
        </p>
      ...
      <section className="flex flex-col md:flex-row justify-between items-start gap-10">
        <div className="md:w-1/2 space-y-4">
          <h1 className="text-3xl md:text-4xl font-bold text-[#4377b2] leading-snug">
            50-Hour Kundalini Yoga Course <br /> Awaken Your Inner Energy
          </h1>
          <p className="text-gray-700 text-sm">
            Dive deep into Kundalini Yoga with breathing techniques, kriyas,
            and meditations that unlock your full potential and balance mind
            and body.
          </p>
          <ul className="list-disc list-inside text-sm text-gray-700 space-y-1">
            <li>Learn dynamic Kundalini kriyas and meditation practices.</li>
            <li>Awaken and channel your inner energy safely and effectively.</li>
            <li>Boost mental clarity, emotional balance, and spiritual growth.</li>
            <li>Includes detailed video instructions and guided practices.</li>
            <li>Perfect for beginners and experienced yogis alike.</li>
          </ul>
...
export default KundaliniYogaCoursePage;
