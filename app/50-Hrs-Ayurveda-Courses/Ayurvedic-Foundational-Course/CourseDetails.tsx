...
const CourseDetails = () => {
  const features = [
    ...
    { id: 2, icon: <Zap />, title: "Ayurveda Core Principles" },
    ...
    { id: 7, icon: <Settings />, title: "Doshas, Dhatus & Agni" },
    { id: 8, icon: <Activity />, title: "Practical Ayurvedic Applications" },
    { id: 9, icon: <Users />, title: "Expert Support & Guidance" },
  ];
    ...
    <section className="bg-[#f9fafb] text-[#4377b2] py-20 px-6">
      <div className="max-w-6xl mx-auto text-center">
        ...
        <p className="mb-10 max-w-2xl mx-auto text-lg leading-relaxed text-[#4377b2]/90">
          Build a solid foundation in Ayurveda by understanding its core concepts including doshas, dhatus, agni, and holistic health practices.
        </p>
        <button className="mb-12 border-2 border-[#4377b2] text-[#4377b2] font-semibold px-8 py-3 rounded-full hover:bg-[#4377b2] hover:text-white transition">
          Enroll in Ayurvedic Foundational Course
        </button>
            ...
            >
              ...
              <div>
                ...
                <p className="text-sm text-[#4377b2]/80">
                  Gain practical knowledge and skills to apply Ayurvedic wisdom in daily life for balanced health and well-being.
                </p>
              </div>
            </div>
          ))}
