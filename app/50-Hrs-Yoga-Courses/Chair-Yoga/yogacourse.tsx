...
const features = [
  ...
  "✅ 50-Hour Chair Yoga Curriculum",
  "✅ Downloadable Chair Yoga Guide",
    ...
    <div className="relative bg-[#e8eefb] rounded-2xl p-8 max-w-3xl w-full overflow-hidden">
      <div className="text-center md:text-left">
        ...
        <p className="text-gray-700 mb-4">
          ...
          <strong>50-Hour Chair Yoga for Mobility & Wellness</strong> course.
        ...
        <p className="text-gray-700 mb-4">
          ...
          refund—no questions asked. Explore the course, practice the gentle
          chair-based yoga routines, and decide with complete peace of mind.
        </p>
        <p className="text-gray-900 font-semibold mb-6">
          You’ve got nothing to lose and a healthier body to gain.
        </p>
      ...
      <section className="flex flex-col md:flex-row justify-between items-start gap-10">
        <div className="md:w-1/2 space-y-4">
          <h1 className="text-3xl md:text-4xl font-bold text-[#4377b2] leading-snug">
            50-Hour Chair Yoga <br /> for Mobility & Wellness
          </h1>
          <p className="text-gray-700 text-sm">
            Experience gentle, effective yoga adapted for all levels and abilities.
            Improve flexibility, reduce stress, and enhance overall wellness from the comfort of your chair.
          </p>
          <ul className="list-disc list-inside text-sm text-gray-700 space-y-1">
            <li>Safe and accessible yoga routines for every body.</li>
            <li>Improve posture, balance, and circulation.</li>
            <li>Reduce pain and stiffness with gentle movements.</li>
            <li>Includes step-by-step videos and practice guides.</li>
            <li>Perfect for seniors, office workers, and beginners.</li>
          </ul>
...
export default ChairYogaCoursePage;
