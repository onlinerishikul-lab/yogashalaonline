...
const UniqueCourseSection = () => {
  const items = [
    ...
    {
      title: "Engaging & Age-Appropriate Techniques",
      icon: <Sun className="w-6 h-6 text-sky-600" />,
    },
    {
      title: "95-Hour Specialized Kids Yoga Training",
      icon: <GraduationCap className="w-6 h-6 text-sky-600" />,
    },
    {
      title: "Fostering Fun, Focus & Flexibility",
    ...
    <section className="bg-white py-16 px-6 md:px-10 lg:px-20">
      <div className="max-w-6xl mx-auto text-center mb-10">
        <h2 className="text-3xl md:text-4xl font-bold text-sky-600">
          What Makes Our “95-Hrs Yoga Courses / Kids Yoga Course” Unique?
        </h2>
        <p className="text-gray-600 mt-4 max-w-2xl mx-auto text-sm md:text-base">
          Train to become an inspiring kids yoga teacher with our 95-hour Kids Yoga Course.  
          Learn playful and effective methods designed to engage children, promoting health, mindfulness, and joy.
        </p>
      </div>
