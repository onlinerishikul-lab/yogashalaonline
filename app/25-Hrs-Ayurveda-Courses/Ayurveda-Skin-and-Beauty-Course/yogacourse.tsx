...
const features = [
  ...
  "✅ 25-Hour Ayurveda Skin & Beauty Curriculum",
  "✅ Downloadable Beauty & Skincare Guide",
    ...
    <div className="relative bg-[#e8eefb] rounded-2xl p-8 max-w-3xl w-full overflow-hidden">
      <div className="text-center md:text-left">
        ...
        <p className="text-gray-700 mb-4">
          ...
          <strong>25-Hrs Ayurveda Skin and Beauty Course</strong>. But if it doesn’t meet your expectations, we’ve got you covered.
        </p>
        <p className="text-gray-700 mb-4">
      ...
      <section className="flex flex-col md:flex-row justify-between items-start gap-10">
        <div className="md:w-1/2 space-y-4">
          <h1 className="text-3xl md:text-4xl font-bold text-[#4377b2] leading-snug">
            25-Hrs Ayurveda Courses <br /> Ayurveda Skin and Beauty Course
          </h1>
          <p className="text-gray-700 text-sm">
            Discover the secrets of radiant skin and natural beauty through Ayurvedic herbs, skincare rituals, and holistic wellness principles.
          </p>
          <ul className="list-disc list-inside text-sm text-gray-700 space-y-1">
            <li>Learn Ayurvedic skincare routines for glowing skin.</li>
            <li>Understand herbal remedies for skin health.</li>
            <li>Explore diet and lifestyle tips for beauty from within.</li>
            <li>Includes HD video lessons and downloadable beauty guides.</li>
            <li>Perfect for beauty enthusiasts and Ayurveda practitioners.</li>
          </ul>
