...
const features = [
  ...
  "✅ 100-Hour Hatha Yoga Teacher Training Curriculum",
    ...
    <div className="relative bg-[#e8eefb] rounded-2xl p-8 max-w-3xl w-full overflow-hidden">
      <div className="text-center md:text-left">
        ...
        <p className="text-gray-700 mb-4">
          ...
          <strong>100-Hrs Hatha Yoga TTC</strong>. But if it doesn’t meet your
      ...
      <section className="flex flex-col md:flex-row justify-between items-start gap-10">
        <div className="md:w-1/2 space-y-4">
          <h1 className="text-3xl md:text-4xl font-bold text-[#4377b2] leading-snug">
            100-Hrs Hatha Yoga Teacher Training Course
          </h1>
          <p className="text-gray-700 text-sm">
            Comprehensive Hatha Yoga TTC designed for aspiring yoga teachers and
            dedicated practitioners. Build a strong foundation and advanced
            skills.
          </p>
          <ul className="list-disc list-inside text-sm text-gray-700 space-y-1">
            <li>Learn classical Hatha Yoga techniques and philosophy.</li>
            <li>Develop teaching skills for safe and effective classes.</li>
            <li>Includes pranayama, asanas, meditation, and anatomy.</li>
            <li>Downloadable course manual and HD video lessons included.</li>
            <li>Perfect for beginners and experienced yogis aiming to teach.</li>
          </ul>
