...
const features = [
  ...
  "✅ 300-Hour Multi-Style Yoga Curriculum",
    ...
    <div className="relative bg-[#e8eefb] rounded-2xl p-8 max-w-3xl w-full overflow-hidden">
      <div className="text-center md:text-left">
        ...
        <p className="text-gray-700 mb-4">
          ...
          <strong>300-Hour Multi-Style Yoga TTC</strong>. But if it doesn’t meet
          your expectations, we’ve got you covered.
        </p>
        <p className="text-gray-700 mb-4">
          Simply email us within <strong>30 days</strong> of purchase for a full
      ...
      <section className="flex flex-col md:flex-row justify-between items-start gap-10">
        <div className="md:w-1/2 space-y-4">
          ...
          <p className="text-gray-700 text-sm">
            Master advanced yoga practices across multiple styles with this
            intensive 300-hour teacher training course designed for dedicated
            yoga professionals.
          </p>
          <ul className="list-disc list-inside text-sm text-gray-700 space-y-1">
            <li>Explore advanced techniques in Hatha, Vinyasa, and other styles.</li>
            <li>Deep dive into anatomy, teaching methods, and philosophy.</li>
            <li>Includes hands-on workshops and meditation training.</li>
            <li>Lifetime access to all course content and updates.</li>
            <li>Ideal for serious yoga instructors seeking advanced certification.</li>
          </ul>
        ...
        <div className="md:w-1/2 w-full">
          ...
          <div className="text-center text-xs text-gray-500 mt-2">
            🔒 100% Secure Payment. Full refund within 30 days if you’re not
            satisfied.
          </div>
        </div>
      </section>
