...
const PricingCard = ({
  ...
  <div className="flex flex-col justify-between border border-[#4377b2] rounded-xl p-4 bg-white shadow-md w-full sm:w-[300px] md:w-[260px] transition hover:shadow-lg">
    <div>
