...
const features = [
  ...
  "✅ Comprehensive Prenatal Yoga Practices",
  "✅ Downloadable Prenatal Yoga Guide",
    ...
    <div className="relative bg-[#e8eefb] rounded-2xl p-8 max-w-3xl w-full overflow-hidden">
      <div className="text-center md:text-left">
        ...
        <p className="text-gray-700 mb-4">
          ...
          <strong>Prenatal Yoga Course</strong>. But if it doesn’t meet your
      ...
      <section className="flex flex-col md:flex-row justify-between items-start gap-10">
        <div className="md:w-1/2 space-y-4">
          ...
          <p className="text-gray-700 text-sm">
            Safely practice yoga tailored for pregnancy, promoting relaxation,
            strength, and well-being for both mother and baby.
          </p>
          <ul className="list-disc list-inside text-sm text-gray-700 space-y-1">
            <li>Learn gentle and safe prenatal yoga postures.</li>
            <li>Techniques for breathing, relaxation, and stress relief.</li>
            <li>Guidance on body awareness and alignment during pregnancy.</li>
            <li>Includes video sessions and downloadable course materials.</li>
            <li>Suitable for all trimesters and beginners.</li>
          </ul>
