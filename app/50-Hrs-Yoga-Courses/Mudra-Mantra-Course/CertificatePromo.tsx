      ...
      <div className="max-w-6xl mx-auto flex flex-col-reverse md:flex-row items-center justify-between gap-12">
        ...
        <div className="md:w-1/2 text-center md:text-left">
          <h2 className="text-3xl md:text-5xl font-extrabold mb-5 leading-tight">
            Ready to Earn Your <br /> Mudra & Mantra Certificate?
          </h2>
          <p className="text-lg mb-8 text-[#f9fafb]">
            Discover the ancient power of hand gestures and sacred sounds in our Mudra & Mantra Course. 
            Deepen your spiritual practice and receive a certificate as a testament to your growth 
            and knowledge.
          </p>
        ...
        <div className="md:w-1/2 flex justify-center">
          <Image
            ...
            alt="Mudra & Mantra Certificate Preview"
            width={512}
            height={212}
