...
const features = [
  ...
  "✅ Specialized Postnatal Yoga Practices",
  "✅ Downloadable Postnatal Yoga Guide",
    ...
    <div className="relative bg-[#e8eefb] rounded-2xl p-8 max-w-3xl w-full overflow-hidden">
      <div className="text-center md:text-left">
        ...
        <p className="text-gray-700 mb-4">
          ...
          <strong>Postnatal Yoga Course</strong>. But if it doesn’t meet your
      ...
      <section className="flex flex-col md:flex-row justify-between items-start gap-10">
        <div className="md:w-1/2 space-y-4">
          ...
          <p className="text-gray-700 text-sm">
            Specialized yoga practices to support mothers during the postnatal
            period. Strengthen your body, restore balance, and nurture your
            wellbeing safely.
          </p>
          <ul className="list-disc list-inside text-sm text-gray-700 space-y-1">
            <li>Safe yoga sequences for postnatal recovery.</li>
            <li>Focus on core strength, pelvic floor, and flexibility.</li>
            <li>Techniques to reduce stress and improve sleep.</li>
            <li>Includes video demonstrations and downloadable guides.</li>
            <li>Perfect for new mothers and yoga instructors.</li>
          </ul>
