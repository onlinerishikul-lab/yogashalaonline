...
const features = [
  ...
  "✅ 75-Hour Asana Clinic Curriculum",
    ...
    <div className="relative bg-[#e8eefb] rounded-2xl p-8 max-w-3xl w-full overflow-hidden">
      <div className="text-center md:text-left">
        ...
        <p className="text-gray-700 mb-4">
          ...
          <strong>75-Hrs Asana Clinic</strong>. But if it doesn’t meet your
      ...
      <section className="flex flex-col md:flex-row justify-between items-start gap-10">
        <div className="md:w-1/2 space-y-4">
          <h1 className="text-3xl md:text-4xl font-bold text-[#4377b2] leading-snug">
            75-Hrs Asana Clinic Yoga Course
          </h1>
          <p className="text-gray-700 text-sm">
            Deepen your understanding of yoga postures with our intensive 75-hour
            Asana Clinic, designed to improve alignment, flexibility, and injury
            prevention.
          </p>
          <ul className="list-disc list-inside text-sm text-gray-700 space-y-1">
            <li>Detailed breakdown of foundational and advanced asanas.</li>
            <li>Focus on anatomy and safe alignment techniques.</li>
            <li>Includes modifications and therapeutic variations.</li>
            <li>Downloadable manual and lifetime course access.</li>
            <li>Perfect for yoga practitioners and teachers seeking deeper practice.</li>
          </ul>
