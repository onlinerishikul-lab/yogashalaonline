    ...
    <div className="relative bg-[#e8eefb] rounded-2xl p-8 max-w-3xl w-full overflow-hidden">
      <div className="text-center md:text-left">
        ...
        <p className="text-gray-700 mb-4">
          ...
          <strong>Pranayama Course</strong>. But if it doesn’t meet your
      ...
      <section className="flex flex-col md:flex-row justify-between items-start gap-10">
        <div className="md:w-1/2 space-y-4">
          ...
          <p className="text-gray-700 text-sm">
            Learn powerful breathing techniques to enhance your energy, calm
            the mind, and improve overall wellness through this comprehensive
            pranayama training.
          </p>
          <ul className="list-disc list-inside text-sm text-gray-700 space-y-1">
            <li>Master foundational and advanced pranayama methods.</li>
            <li>Boost respiratory health and mental clarity.</li>
            <li>Improve focus, relaxation, and emotional balance.</li>
            <li>Includes guided video sessions and downloadable materials.</li>
            <li>Suitable for beginners and experienced practitioners.</li>
          </ul>
