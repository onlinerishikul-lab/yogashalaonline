      ...
      <div className="max-w-6xl mx-auto flex flex-col-reverse md:flex-row items-center justify-between gap-12">
        ...
        <div className="md:w-1/2 text-center md:text-left">
          <h2 className="text-3xl md:text-5xl font-extrabold mb-5 leading-tight">
            Ready to Earn Your <br /> Pranayama TTC Certificate?
          </h2>
          <p className="text-lg mb-8 text-[#f9fafb]">
            Dive deep into the art of yogic breathing. Our Pranayama Teacher Training Course 
            empowers you to teach conscious breath control with confidence. 
            Complete the course and receive your certification to guide others toward balance and vitality.
          </p>
        ...
        <div className="md:w-1/2 flex justify-center">
          <Image
            ...
            alt="Pranayama TTC Certificate Preview"
            width={512}
            height={212}
