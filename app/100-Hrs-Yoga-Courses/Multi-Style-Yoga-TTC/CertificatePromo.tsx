      ...
      <div className="max-w-6xl mx-auto flex flex-col-reverse md:flex-row items-center justify-between gap-12">
        ...
        <div className="md:w-1/2 text-center md:text-left">
          <h2 className="text-3xl md:text-5xl font-extrabold mb-5 leading-tight">
            Discover the Power of <br /> 100-Hrs Multi-Style Yoga TTC
          </h2>
          <p className="text-lg mb-8 text-[#f9fafb]">
            Dive into a rich blend of yoga traditions with our 100-Hour Multi-Style Yoga 
            Teacher Training Course. Master Hatha, Vinyasa, and more — all in one dynamic program.
          </p>
          <Link href="/100-hrs-yoga-courses/multi-style-yoga-ttc" passHref legacyBehavior>
        ...
        <div className="md:w-1/2 flex justify-center">
          <Image
            ...
            alt="100-Hrs Multi-Style Yoga TTC Certificate Preview"
            width={512}
            height={212}
