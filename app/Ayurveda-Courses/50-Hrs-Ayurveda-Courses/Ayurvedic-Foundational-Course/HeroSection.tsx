...
const HeroSection = () => {
  ...
  return (
    <div className="relative h-screen bg-cover bg-center" style={{ backgroundImage: 'url("/ayurveda1.jpg")' }}>
      {/* Header Menu */}
      <Header />
      ...
      <div className="absolute inset-0 bg-black bg-opacity-50 flex flex-col justify-center items-center text-white px-4 pt-20">
        <h1 className="text-4xl md:text-5xl font-bold text-center leading-snug drop-shadow-lg">
          Ayurvedic Foundational Course 
          <br />
          Begin Your Journey into Holistic Living.
        </h1>
