...
const UniqueCourseSection = () => {
  const items = [
    {
      title: "Expert Meditation Instructors",
      icon: <Users className="w-6 h-6 text-sky-600" />,
    },
    {
      title: "Mindfulness & Stress Relief Techniques",
      icon: <Sun className="w-6 h-6 text-sky-600" />,
    },
    {
      title: "Certified Meditation Teacher Training",
      icon: <GraduationCap className="w-6 h-6 text-sky-600" />,
    },
    {
      title: "Track Your Meditation Progress",
    ...
    <section className="bg-white py-16 px-6 md:px-10 lg:px-20">
      <div className="max-w-6xl mx-auto text-center mb-10">
        <h2 className="text-3xl md:text-4xl font-bold text-sky-600">
          What Makes Our “50-Hrs Meditation TTC” Unique?
        </h2>
        <p className="text-gray-600 mt-4 max-w-2xl mx-auto text-sm md:text-base">
          Learn powerful meditation practices designed to reduce stress and cultivate mindfulness.
          This 50-hour teacher training course prepares you to guide others on their meditation journey.
        </p>
      </div>
