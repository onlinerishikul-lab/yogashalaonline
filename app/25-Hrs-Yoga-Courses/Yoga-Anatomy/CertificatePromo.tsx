...
const CertificatePromo = () => {
  return (
    <section className="bg-[#4377b2] py-12 px-4 text-white">
      <div className="max-w-6xl mx-auto flex flex-col md:flex-row items-center justify-between gap-10">
        ...
        <div className="md:w-1/2">
          ...
          <Link href="/get-certificate" passHref legacyBehavior>
            <a className="inline-block bg-white text-[#4377b2] font-semibold px-6 py-3 rounded-full shadow hover:bg-gray-100 transition duration-300">
