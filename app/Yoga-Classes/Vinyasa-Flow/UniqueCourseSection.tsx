...
const UniqueCourseSection = () => {
  const items = [
    {
      title: "Skilled Vinyasa Flow Instructors",
      icon: <Users className="w-6 h-6 text-sky-600" />,
    },
    {
      title: "Dynamic Movement & Breath Synchronization",
      icon: <Sun className="w-6 h-6 text-sky-600" />,
    },
    {
      title: "Build Strength, Flexibility & Endurance",
      icon: <GraduationCap className="w-6 h-6 text-sky-600" />,
    },
    {
      title: "Personalized Flow Adjustments & Feedback",
    ...
    <section className="bg-white py-16 px-6 md:px-10 lg:px-20">
      <div className="max-w-6xl mx-auto text-center mb-10">
        <h2 className="text-3xl md:text-4xl font-bold text-sky-600">
          What Makes Our “Vinyasa Flow Yoga” Course Unique?
        </h2>
        <p className="text-gray-600 mt-4 max-w-2xl mx-auto text-sm md:text-base">
          Immerse yourself in the rhythm of breath and movement with our Vinyasa Flow Yoga course.  
          Experience a dynamic practice designed to build strength, flexibility, and mindful awareness.
        </p>
      </div>
