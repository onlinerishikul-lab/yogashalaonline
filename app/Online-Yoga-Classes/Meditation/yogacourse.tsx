...
const features = [
  ...
  "✅ Downloadable Meditation Guides",
    ...
    <div className="relative bg-[#e8eefb] rounded-2xl p-8 max-w-3xl w-full overflow-hidden">
      <div className="text-center md:text-left">
        ...
        <p className="text-gray-700 mb-4">
          ...
          <strong>Meditation Course</strong>. But if it doesn’t meet your
      ...
      <section className="flex flex-col md:flex-row justify-between items-start gap-10">
        <div className="md:w-1/2 space-y-4">
          ...
          <p className="text-gray-700 text-sm">
            Discover inner peace and mindfulness with guided meditation
            techniques designed to reduce stress and improve your wellbeing.
          </p>
          <ul className="list-disc list-inside text-sm text-gray-700 space-y-1">
            <li>Learn various meditation styles and practices.</li>
            <li>Develop daily mindfulness routines.</li>
            <li>Techniques for stress relief and mental clarity.</li>
            <li>Includes guided audio and video sessions.</li>
            <li>Suitable for beginners and experienced meditators.</li>
          </ul>
