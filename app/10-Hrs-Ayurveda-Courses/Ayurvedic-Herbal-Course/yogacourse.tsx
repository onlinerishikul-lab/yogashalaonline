...
const features = [
  ...
  "✅ 10-Hour Ayurvedic Herbal Curriculum",
  "✅ Downloadable Herbal Remedies Guide",
    ...
    <div className="relative bg-[#e8eefb] rounded-2xl p-8 max-w-3xl w-full overflow-hidden">
      <div className="text-center md:text-left">
        ...
        <p className="text-gray-700 mb-4">
          ...
          <strong>10-Hrs Ayurvedic Herbal Course</strong>. But if it doesn’t meet your expectations, we’ve got you covered.
        </p>
        <p className="text-gray-700 mb-4">
      ...
      <section className="flex flex-col md:flex-row justify-between items-start gap-10">
        <div className="md:w-1/2 space-y-4">
          <h1 className="text-3xl md:text-4xl font-bold text-[#4377b2] leading-snug">
            10-Hrs Ayurveda Courses <br /> Ayurvedic Herbal Course
          </h1>
          <p className="text-gray-700 text-sm">
            Dive deep into Ayurvedic herbal wisdom to promote natural healing and holistic wellness. Choose your learning plan and start today.
          </p>
          <ul className="list-disc list-inside text-sm text-gray-700 space-y-1">
            <li>Explore key herbs and their healing properties.</li>
            <li>Learn preparation methods for herbal remedies.</li>
            <li>Understand the role of herbs in balancing doshas.</li>
            <li>Includes HD video lessons and downloadable herbal guides.</li>
            <li>Ideal for beginners and Ayurveda enthusiasts.</li>
          </ul>
