      ...
      <div className="max-w-6xl mx-auto flex flex-col-reverse md:flex-row items-center justify-between gap-12">
        ...
        <div className="md:w-1/2 text-center md:text-left">
          <h2 className="text-3xl md:text-5xl font-extrabold mb-5 leading-tight">
            Ready to Begin Your <br /> 15-Hrs Ayurveda Garbha Samskara Course?
          </h2>
          <p className="text-lg mb-8 text-[#f9fafb]">
            Discover the ancient practices of Garbha Samskara, the Ayurvedic prenatal rituals 
            promoting healthy development. Enroll in this 15-hour course and earn your certificate 
            to deepen your understanding of prenatal wellness.
          </p>
        ...
        <div className="md:w-1/2 flex justify-center">
          <Image
            ...
            alt="15-Hrs Ayurveda Garbha Samskara Course Certificate Preview"
            width={512}
            height={212}
