...
const features = [
  ...
  "✅ 50-Hour Restorative Yoga Curriculum",
    ...
    <div className="relative bg-[#e8eefb] rounded-2xl p-8 max-w-3xl w-full overflow-hidden">
      <div className="text-center md:text-left">
        ...
        <p className="text-gray-700 mb-4">
          We’re confident you’ll find value in our{" "}
          <strong>50-Hour Restorative Yoga Teacher Training Course</strong>.
          But if it’s not the right fit, you’re covered.
        </p>
        <p className="text-gray-700 mb-4">
          Simply contact us within <strong>7 days</strong> of purchase for a full
          refund—no questions asked. Try the course with peace of mind.
        </p>
        <p className="text-gray-900 font-semibold mb-6">
          Begin your restorative yoga teaching journey risk-free.
        </p>
      ...
      <section className="flex flex-col md:flex-row justify-between items-start gap-10">
        <div className="md:w-1/2 space-y-4">
          <h1 className="text-3xl md:text-4xl font-bold text-[#4377b2] leading-snug">
            50-Hour Restorative Yoga <br /> Teacher Training Course
          </h1>
          <p className="text-gray-700 text-sm">
            Learn how to guide deeply relaxing and healing restorative yoga
            practices. This course equips you to help students reduce stress,
            restore balance, and promote well-being.
          </p>
          <ul className="list-disc list-inside text-sm text-gray-700 space-y-1">
            <li>Master restorative poses and props for optimal support.</li>
            <li>Understand the therapeutic benefits of slow, mindful practice.</li>
            <li>Develop sequences tailored to various needs and conditions.</li>
            <li>Includes HD video lessons and a downloadable training manual.</li>
            <li>Perfect for yoga teachers and wellness professionals.</li>
          </ul>
