...
const UniqueCourseSection = () => {
  const items = [
    {
      title: "Advanced Multi-Style Yoga Experts",
      icon: <Users className="w-6 h-6 text-sky-600" />,
    },
    {
      title: "Comprehensive 300-Hour Intensive Training",
    ...
    {
      title: "Mastery Across Diverse Yoga Traditions",
    ...
    <section className="bg-white py-16 px-6 md:px-10 lg:px-20">
      <div className="max-w-6xl mx-auto text-center mb-10">
        <h2 className="text-3xl md:text-4xl font-bold text-sky-600">
          What Makes Our “300-Hrs Yoga Courses / Multi-Style Yoga TTC” Unique?
        </h2>
        <p className="text-gray-600 mt-4 max-w-2xl mx-auto text-sm md:text-base">
          Take your yoga practice and teaching to the highest level with our 300-hour Multi-Style Yoga TTC.  
          This intensive program offers deep immersion into multiple yoga styles, preparing you to teach with confidence and expertise worldwide.
        </p>
      </div>
