      ...
      <div className="max-w-6xl mx-auto flex flex-col-reverse md:flex-row items-center justify-between gap-12">
        ...
        <div className="md:w-1/2 text-center md:text-left">
          <h2 className="text-3xl md:text-5xl font-extrabold mb-5 leading-tight">
            Ready to Earn Your <br /> Pregnancy Yoga Certificate?
          </h2>
          <p className="text-lg mb-8 text-[#f9fafb]">
            Support and empower expecting mothers through the gentle practice of Pregnancy Yoga. 
            Complete this specialized course and receive a certificate that validates your ability 
            to guide safe and nurturing sessions during all stages of pregnancy.
          </p>
        ...
        <div className="md:w-1/2 flex justify-center">
          <Image
            ...
            alt="Pregnancy Yoga Certificate Preview"
            width={512}
            height={212}
