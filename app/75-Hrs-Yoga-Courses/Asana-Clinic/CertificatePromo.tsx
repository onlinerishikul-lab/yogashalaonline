      ...
      <div className="max-w-6xl mx-auto flex flex-col-reverse md:flex-row items-center justify-between gap-12">
        ...
        <div className="md:w-1/2 text-center md:text-left">
          <h2 className="text-3xl md:text-5xl font-extrabold mb-5 leading-tight">
            Master Your Practice with Our <br /> 75-Hrs Asana Clinic
          </h2>
          <p className="text-lg mb-8 text-[#f9fafb]">
            Focus on precision and alignment in yoga postures with our specialized 75-Hour 
            Asana Clinic course. Perfect your techniques and deepen your body awareness.
          </p>
          <Link href="/75-hrs-yoga-courses/asana-clinic" passHref legacyBehavior>
        ...
        <div className="md:w-1/2 flex justify-center">
          <Image
            ...
            alt="75-Hrs Asana Clinic Certificate Preview"
            width={512}
            height={212}
