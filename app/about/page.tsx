      ...
      <div className="bg-white">
        <div className="h-screen min-h-fit md:h-screen md:min-h-[800px]">
          ...
          <div className="container mx-auto py-16">
            <h1 className="text-[#4377B2] text-4xl font-bold mb-8">
              About Rishikul Yogshala
            </h1>

            <div className="space-y-6 text-gray-700 max-w-7xl">
              ...
              <p className="leading-relaxed">
                ...
                modules on meditation, Ayurveda, and yogic philosophy.Join us on
                this journey of self-discovery and transformation as you become
                a certified yoga teacher with Rishikul Online. Let us guide you
                towards your true potential in mind, body, and soul. Namaste.
              </p>
            </div>
          </div>
        </div>
