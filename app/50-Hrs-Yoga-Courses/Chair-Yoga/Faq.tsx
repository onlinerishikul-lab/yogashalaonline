...
const faqs = [
  {
    question: "Who is this 50-hrs Chair Yoga course for?",
    answer:
      "This course is perfect for individuals with limited mobility, office workers, seniors, or anyone seeking a gentle yoga practice from the comfort of a chair.",
  },
  {
    question: "Do I need prior yoga experience?",
    answer:
      "Not at all. Chair Yoga is designed to be accessible to all levels, including complete beginners.",
  },
  {
    question: "Is this course available online?",
    answer:
      "Yes, the entire course is online and self-paced, allowing you to practice anytime, anywhere.",
  },
  {
    ...
    <section className="bg-[#f9fafb] px-4 py-16">
      <div className="max-w-2xl mx-auto">
        <h1 className="text-3xl font-bold text-center text-[#4377b2] mb-2">
          Chair Yoga – Frequently Asked Questions
        </h1>
        <p className="text-gray-600 text-center mb-8 text-sm">
          Have doubts before joining the 50-Hour Chair Yoga course? We’ve got answers.
        </p>
