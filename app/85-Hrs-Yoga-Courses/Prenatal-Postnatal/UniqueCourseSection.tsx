...
const UniqueCourseSection = () => {
  const items = [
    {
      title: "Certified Prenatal & Postnatal Yoga Experts",
      icon: <Users className="w-6 h-6 text-sky-600" />,
    },
    {
      title: "Focused 85-Hour Specialized Training",
      icon: <Sun className="w-6 h-6 text-sky-600" />,
    },
    {
      title: "Holistic Care for Mother & Baby",
      icon: <GraduationCap className="w-6 h-6 text-sky-600" />,
    },
    {
      title: "Safe Practices & Personalized Guidance",
    ...
    <section className="bg-white py-16 px-6 md:px-10 lg:px-20">
      <div className="max-w-6xl mx-auto text-center mb-10">
        <h2 className="text-3xl md:text-4xl font-bold text-sky-600">
          What Makes Our “85-Hrs Yoga Courses / Prenatal Postnatal” Unique?
        </h2>
        <p className="text-gray-600 mt-4 max-w-2xl mx-auto text-sm md:text-base">
          Empower yourself with specialized skills through our 85-hour Prenatal and Postnatal Yoga course.  
          Learn safe, effective techniques to support mothers through pregnancy and beyond, nurturing wellness for both mother and child.
        </p>
      </div>
