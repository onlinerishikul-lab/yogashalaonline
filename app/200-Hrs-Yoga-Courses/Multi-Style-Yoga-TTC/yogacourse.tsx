...
const features = [
  ...
  "✅ 200-Hour Multi-Style Yoga Curriculum",
    ...
    <div className="relative bg-[#e8eefb] rounded-2xl p-8 max-w-3xl w-full overflow-hidden">
      <div className="text-center md:text-left">
        ...
        <p className="text-gray-700 mb-4">
          ...
          <strong>200-Hour Multi-Style Yoga TTC</strong>. But if it doesn’t meet
      ...
      <section className="flex flex-col md:flex-row justify-between items-start gap-10">
        <div className="md:w-1/2 space-y-4">
          ...
          <p className="text-gray-700 text-sm">
            Dive deep into multiple yoga styles with this comprehensive 200-hour
            teacher training course designed for aspiring yoga instructors.
          </p>
          <ul className="list-disc list-inside text-sm text-gray-700 space-y-1">
            <li>Learn diverse yoga techniques including Hatha, Vinyasa, and more.</li>
            <li>In-depth anatomy, philosophy, and teaching methodology.</li>
            <li>Includes practical workshops and meditation practices.</li>
            <li>Lifetime access to course materials and videos.</li>
            <li>Perfect for future yoga teachers and serious practitioners.</li>
          </ul>
