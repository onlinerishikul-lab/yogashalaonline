      ...
      <div className="max-w-6xl mx-auto flex flex-col-reverse md:flex-row items-center justify-between gap-12">
        ...
        <div className="w-full md:w-1/2 text-center md:text-left">
          <h2 className="text-2xl sm:text-3xl md:text-4xl lg:text-5xl font-extrabold mb-5 leading-tight">
            Earn Your Yoga Philosophy Certificate
          </h2>
          <p className="text-base sm:text-lg mb-8 text-[#f9fafb]">
           Begin your journey into yoga’s timeless wisdom. Complete this self-paced online course and receive a certificate that honors your growth, discipline, and dedication to a deeper path in yoga.
          </p>
          <Link href="/contact">
