...
const CourseDetails = () => {
  const features = [
    ...
    { id: 2, icon: <Moon />, title: "Deep Meditation Techniques" },
    ...
    { id: 7, icon: <Settings />, title: "Mantras & Mindfulness Tools" },
    { id: 8, icon: <Activity />, title: "Stress Relief & Focus" },
    { id: 9, icon: <Users />, title: "Guidance from Experienced Meditation Teachers" },
  ];
    ...
    <section className="bg-[#f9fafb] text-[#4377b2] py-20 px-6">
      <div className="max-w-6xl mx-auto text-center">
        <h2 className="text-4xl md:text-5xl font-bold mb-6">
          What Will You Learn in Meditation TTC?
        </h2>
        <p className="mb-10 max-w-2xl mx-auto text-lg leading-relaxed text-[#4377b2]/90">
          Master meditation techniques for inner peace, focus, and stress reduction with this comprehensive 50-hour Teacher Training Course.
        </p>
            ...
            >
              ...
              <div>
                ...
                <p className="text-sm text-[#4377b2]/80">
                  Learn meditation postures, breath control, mantra chanting, and mindfulness practices to teach and practice meditation effectively.
                </p>
              </div>
            </div>
          ))}
