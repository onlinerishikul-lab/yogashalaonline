      ...
      <div className="max-w-6xl mx-auto flex flex-col-reverse md:flex-row items-center justify-between gap-12">
        ...
        <div className="md:w-1/2 text-center md:text-left">
          <h2 className="text-3xl md:text-5xl font-extrabold mb-5 leading-tight">
            Inspire the Young with Our <br /> 95-Hrs Kids Yoga Course
          </h2>
          <p className="text-lg mb-8 text-[#f9fafb]">
            Empower children with the joy and benefits of yoga through our 95-Hour Kids 
            Yoga Course. Develop playful, safe, and effective yoga sessions tailored for kids.
          </p>
          <Link href="/95-hrs-yoga-courses/kids-yoga-course" passHref legacyBehavior>
        ...
        <div className="md:w-1/2 flex justify-center">
          <Image
            ...
            alt="95-Hrs Kids Yoga Course Certificate Preview"
            width={512}
            height={212}
