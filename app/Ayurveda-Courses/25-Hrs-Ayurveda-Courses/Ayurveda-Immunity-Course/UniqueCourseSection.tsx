...
import { ShieldCheck, Leaf, HeartPulse, Stethoscope } from "lucide-react";

const UniqueCourseSection = () => {
  const items = [
    {
      title: "Strengthen Your Immune System Naturally",
    ...
    {
      title: "Expert Ayurvedic Support",
    ...
    <section className="bg-white py-16 px-6 md:px-10 lg:px-20">
      <div className="max-w-6xl mx-auto text-center mb-10">
        <h2 className="text-3xl md:text-4xl font-bold text-sky-600">
          What Makes Our “25-Hrs Ayurveda Courses / Ayurveda Immunity Course” Unique?
        </h2>
        <p className="text-gray-600 mt-4 max-w-2xl mx-auto text-sm md:text-base">
          Build a resilient immune system with the power of Ayurveda. This 25-hour course covers natural immunity boosters, dietary tips, and lifestyle habits
          to support your body’s defenses and promote long-term health.
        </p>
      </div>
