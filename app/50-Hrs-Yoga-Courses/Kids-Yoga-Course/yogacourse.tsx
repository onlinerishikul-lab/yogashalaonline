...
const features = [
  ...
  "✅ 50-Hour Kids Yoga Curriculum",
  "✅ Fun and Engaging Yoga Videos",
...
const PricingOptions = () => (
  <div className="flex flex-nowrap justify-center items-start gap-4 overflow-x-auto pb-2">
    <PricingCard
      ...
      description="Full course access with one payment."
      price="$450.00"
    ...
    <div className="relative bg-[#e8eefb] rounded-2xl p-8 max-w-3xl w-full overflow-hidden">
      <div className="text-center md:text-left">
        ...
        <p className="text-gray-700 mb-4">
          We’re confident your kids will love the{" "}
          <strong>50-Hour Kids Yoga Course</strong>. If you’re not satisfied,
          get a full refund within 7 days.
        </p>
        <p className="text-gray-700 mb-4">
          Explore fun, easy-to-follow yoga routines designed especially for
          children. Help your kids develop strength, balance, focus, and
          confidence—all from home.
        </p>
        <p className="text-gray-900 font-semibold mb-6">
          Join risk-free and give your kids the gift of joyful yoga practice.
        </p>
      ...
      <section className="flex flex-col md:flex-row justify-between items-start gap-10">
        <div className="md:w-1/2 space-y-4">
          <h1 className="text-3xl md:text-4xl font-bold text-[#4377b2] leading-snug">
            50-Hour Kids Yoga Course <br /> Fun, Fitness & Focus
          </h1>
          <p className="text-gray-700 text-sm">
            Specially designed yoga course for kids to improve strength,
            flexibility, and concentration through fun and interactive sessions.
          </p>
          <ul className="list-disc list-inside text-sm text-gray-700 space-y-1">
            <li>Engaging yoga routines for children of all ages.</li>
            <li>Boosts physical fitness and mental clarity.</li>
            <li>Develops coordination, balance, and mindfulness.</li>
            <li>Includes animated videos and playful exercises.</li>
            <li>Safe, easy-to-follow sessions for home practice.</li>
          </ul>
...
export default KidsYogaCoursePage;
