...
const features = [
  ...
  "✅ 50-Hour Ayurvedic Lifestyle Curriculum",
    ...
    <div className="relative bg-[#e8eefb] rounded-2xl p-8 max-w-3xl w-full overflow-hidden">
      <div className="text-center md:text-left">
        ...
        <p className="text-gray-700 mb-4">
          ...
          <strong>50-Hrs Ayurvedic Lifestyle Course</strong>. But if it doesn’t meet your expectations, we’ve got you covered.
        </p>
        <p className="text-gray-700 mb-4">
      ...
      <section className="flex flex-col md:flex-row justify-between items-start gap-10">
        <div className="md:w-1/2 space-y-4">
          <h1 className="text-3xl md:text-4xl font-bold text-[#4377b2] leading-snug">
            50-Hrs Ayurveda Courses <br /> Ayurvedic Lifestyle Course
          </h1>
          <p className="text-gray-700 text-sm">
            Transform your daily living with Ayurvedic lifestyle principles, focusing on nutrition, mindfulness, and holistic wellness for lasting health.
          </p>
          <ul className="list-disc list-inside text-sm text-gray-700 space-y-1">
            <li>Learn Ayurvedic daily routines for body and mind balance.</li>
            <li>Explore nutrition, meditation, and seasonal self-care.</li>
            <li>Understand stress management through Ayurvedic practices.</li>
            <li>Includes HD video lessons and a downloadable lifestyle guide.</li>
            <li>Perfect for anyone seeking holistic and natural health solutions.</li>
          </ul>
