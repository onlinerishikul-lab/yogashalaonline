      ...
      <div className="max-w-6xl mx-auto flex flex-col-reverse md:flex-row items-center justify-between gap-12">
        ...
        <div className="md:w-1/2 text-center md:text-left">
          ...
          <p className="text-lg mb-8 text-[#f9fafb]">
            Embrace gentle and accessible yoga practices designed for all abilities. 
            Complete our comprehensive Chair Yoga course online and receive your certificate 
            recognizing your dedication to wellness and adaptability.
          </p>
          <Link href="/50-Hrs-Yoga-Courses/Chair-Yoga" passHref legacyBehavior>
