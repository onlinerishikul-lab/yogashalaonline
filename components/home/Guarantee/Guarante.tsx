...
const Guarante = () => {
  ...
  return (
    <div className="bg-[#4377B2] bg-cover flex justify-center px-0">
      <div className="w-full text-white text-center">
        <h2 className="mb-6 text-2xl sm:text-3xl md:text-4xl font-bold leading-snug px-4 sm:px-6">
          Ready to begin your Online Yoga Teacher Training journey from the
          comfort of your home?
        </h2>
        <p className="mb-8 text-sm sm:text-base md:text-lg leading-relaxed px-4 sm:px-6">
