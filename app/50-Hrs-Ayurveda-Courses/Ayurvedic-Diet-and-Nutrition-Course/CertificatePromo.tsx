      ...
      <div className="max-w-6xl mx-auto flex flex-col-reverse md:flex-row items-center justify-between gap-12">
        ...
        <div className="md:w-1/2 text-center md:text-left">
          <h2 className="text-3xl md:text-5xl font-extrabold mb-5 leading-tight">
            Ready to Begin Your <br /> 50-Hrs Ayurvedic Diet and Nutrition Course?
          </h2>
          <p className="text-lg mb-8 text-[#f9fafb]">
            Master the principles of Ayurvedic diet and nutrition with our extensive 50-hour course. 
            Gain valuable knowledge to promote balanced health and well-being, and earn your certificate upon completion.
          </p>
        ...
        <div className="md:w-1/2 flex justify-center">
          <Image
            ...
            alt="50-Hrs Ayurvedic Diet and Nutrition Course Certificate Preview"
            width={512}
            height={212}
