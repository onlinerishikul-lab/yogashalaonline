      ...
      <div className="max-w-6xl mx-auto flex flex-col-reverse md:flex-row items-center justify-between gap-12">
        ...
        <div className="md:w-1/2 text-center md:text-left">
          <h2 className="text-3xl md:text-5xl font-extrabold mb-5 leading-tight">
            Ready to Earn Your <br /> Yoga Nidra TTC Certificate?
          </h2>
          <p className="text-lg mb-8 text-[#f9fafb]">
            Master the transformative practice of Yogic Sleep. 
            Our Yoga Nidra Teacher Training Course guides you in delivering deep relaxation sessions 
            that heal and restore. Complete the course and receive your recognized certificate.
          </p>
        ...
        <div className="md:w-1/2 flex justify-center">
          <Image
            ...
            alt="Yoga Nidra TTC Certificate Preview"
            width={512}
            height={212}
