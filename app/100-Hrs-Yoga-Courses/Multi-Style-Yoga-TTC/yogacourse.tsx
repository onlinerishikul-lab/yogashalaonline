...
const features = [
  ...
  "✅ 100-Hour Multi-Style Yoga TTC Curriculum",
    ...
    <div className="relative bg-[#e8eefb] rounded-2xl p-8 max-w-3xl w-full overflow-hidden">
      <div className="text-center md:text-left">
        ...
        <p className="text-gray-700 mb-4">
          ...
          <strong>100-Hrs Multi-Style Yoga TTC</strong>. But if it doesn’t meet your
      ...
      <section className="flex flex-col md:flex-row justify-between items-start gap-10">
        <div className="md:w-1/2 space-y-4">
          <h1 className="text-3xl md:text-4xl font-bold text-[#4377b2] leading-snug">
            100-Hrs Multi-Style Yoga Teacher Training Course
          </h1>
          <p className="text-gray-700 text-sm">
            Comprehensive Multi-Style Yoga TTC crafted for future yoga teachers
            and curious practitioners. Master multiple styles in one course.
          </p>
          <ul className="list-disc list-inside text-sm text-gray-700 space-y-1">
            <li>Learn Hatha, Vinyasa, and Ashtanga Yoga fundamentals.</li>
            <li>Develop a versatile teaching style adaptable to all levels.</li>
            <li>Includes pranayama, alignment, meditation & teaching skills.</li>
            <li>Access high-quality video lessons and a downloadable manual.</li>
            <li>Ideal for new and experienced yogis exploring multiple forms.</li>
          </ul>
