...
const features = [
  ...
  "✅ 15-Hour Ayurvedic Sexual Health Curriculum",
  "✅ Downloadable Relationship Wellness Guide",
    ...
    <div className="relative bg-[#e8eefb] rounded-2xl p-8 max-w-3xl w-full overflow-hidden">
      <div className="text-center md:text-left">
        ...
        <p className="text-gray-700 mb-4">
          ...
          <strong>15-Hrs Ayurvedic Sexual Relationship Course</strong>. But if it doesn’t meet your expectations, we’ve got you covered.
        </p>
        <p className="text-gray-700 mb-4">
      ...
      <section className="flex flex-col md:flex-row justify-between items-start gap-10">
        <div className="md:w-1/2 space-y-4">
          <h1 className="text-3xl md:text-4xl font-bold text-[#4377b2] leading-snug">
            15-Hrs Ayurveda Courses <br /> Ayurvedic Sexual Relationship Course
          </h1>
          <p className="text-gray-700 text-sm">
            Learn ancient Ayurvedic wisdom to enhance intimacy, strengthen bonds, and promote holistic sexual health naturally.
          </p>
          <ul className="list-disc list-inside text-sm text-gray-700 space-y-1">
            <li>Understand Ayurvedic approaches to sexual wellness.</li>
            <li>Explore natural remedies and practices for vitality.</li>
            <li>Gain insights into relationship harmony and balance.</li>
            <li>Includes HD video lessons and downloadable wellness guides.</li>
            <li>Perfect for couples and Ayurveda practitioners.</li>
          </ul>
